...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CMSCalendarPlugin'
        db.create_table('cmsplugin_cmscalendarplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('calendar_plug', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Calendar'])),
        ))
        db.send_create_signal('schedule', ['CMSCalendarPlugin'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CMSCalendarPlugin'
        db.delete_table('cmsplugin_cmscalendarplugin')
