...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Occurrence.content'
        db.add_column('schedule_occurrence', 'content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Occurrence.content'
        db.delete_column('schedule_occurrence', 'content_id')
    ...
    models = {
        ...
        'schedule.event': {
            ...
            'content': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Placeholder']", 'null': 'True', 'blank': 'True'}),
