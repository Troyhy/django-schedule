 ...
 * Django-CMS integration -Troyhy
 * Posiibility to make default event and to copy event.
...
There is cmsplugin and cms app-hook available. Cmsplugin provides listing of upcoming events and app-hook gives ability to embedd schedule app into CMS
